...
public class EnemyAttack implements Runnable {
	...
	public EnemyAttack(EnemyUnit enemyunit, PlayerStudent player, int x, int y, double angel, double speed, int width,
			int height) {
	...
	public void explosePlayer(PlayerStudent player) { // 충돌후 이미지 변경 및 목숨카운트
