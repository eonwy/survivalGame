...
public class PlayerStudent extends JLabel {

   public PlayerStudent player = this;
   ...
   public PlayerStudent(GameFrame gameFrame,String STUDENT) {
      
      this.gameFrame = gameFrame;
      playerIcon = new ImageIcon("images/Player" + STUDENT + ".png");
      playerInvincibleIcon = new ImageIcon("images/" + STUDENT + "무적.png");

      this.invincible = false;

      System.out.println("images/Player" + STUDENT + ".png");
   ...
   public PlayerStudent getPlayer() {
      return player;
   }

   public void setPlayer(PlayerStudent player) {
      this.player = player;
   }
